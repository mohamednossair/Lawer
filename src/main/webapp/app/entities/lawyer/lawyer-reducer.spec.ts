...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './lawyer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LAWYER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LAWYER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LAWYER actions', async () => {
      const arg = { id: 920 };
    ...
    it('dispatches UPDATE_LAWYER actions', async () => {
      const arg = { id: 920 };
    ...
    it('dispatches PARTIAL_UPDATE_LAWYER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LAWYER actions', async () => {
      const arg = 42666;
