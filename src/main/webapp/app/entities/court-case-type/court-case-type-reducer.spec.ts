...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURTCASETYPE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COURTCASETYPE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COURTCASETYPE actions', async () => {
      const arg = { id: 8229 };
    ...
    it('dispatches UPDATE_COURTCASETYPE actions', async () => {
      const arg = { id: 8229 };
    ...
    it('dispatches PARTIAL_UPDATE_COURTCASETYPE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COURTCASETYPE actions', async () => {
      const arg = 42666;
