...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURTCASE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COURTCASE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COURTCASE actions', async () => {
      const arg = { id: 5265 };
    ...
    it('dispatches UPDATE_COURTCASE actions', async () => {
      const arg = { id: 5265 };
    ...
    it('dispatches PARTIAL_UPDATE_COURTCASE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COURTCASE actions', async () => {
      const arg = 42666;
