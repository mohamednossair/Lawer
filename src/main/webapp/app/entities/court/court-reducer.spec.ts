...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './court.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COURT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COURT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COURT actions', async () => {
      const arg = { id: 24987 };
    ...
    it('dispatches UPDATE_COURT actions', async () => {
      const arg = { id: 24987 };
    ...
    it('dispatches PARTIAL_UPDATE_COURT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COURT actions', async () => {
      const arg = 42666;
