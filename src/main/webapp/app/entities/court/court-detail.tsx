    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courtDetailsHeading">
          <Translate contentKey="lawyerApp.court.detail.title">Court</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dd>{courtEntity.courtName}</dd>
        </dl>
        <Button tag={Link} to="/court" replace color="info" data-cy="entityDetailsBackButton">
        ...
        &nbsp;
        <Button tag={Link} to={`/court/${courtEntity.id}/edit`} replace color="primary">
