...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASESESSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CASESESSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CASESESSION actions', async () => {
      const arg = { id: 6909 };
    ...
    it('dispatches UPDATE_CASESESSION actions', async () => {
      const arg = { id: 6909 };
    ...
    it('dispatches PARTIAL_UPDATE_CASESESSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CASESESSION actions', async () => {
      const arg = 42666;
