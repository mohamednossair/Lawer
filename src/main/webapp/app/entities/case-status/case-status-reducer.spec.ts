...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASESTATUS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CASESTATUS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CASESTATUS actions', async () => {
      const arg = { id: 11267 };
    ...
    it('dispatches UPDATE_CASESTATUS actions', async () => {
      const arg = { id: 11267 };
    ...
    it('dispatches PARTIAL_UPDATE_CASESTATUS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CASESTATUS actions', async () => {
      const arg = 42666;
