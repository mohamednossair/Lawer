...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CASEDOCUMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CASEDOCUMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CASEDOCUMENT actions', async () => {
      const arg = { id: 11965 };
    ...
    it('dispatches UPDATE_CASEDOCUMENT actions', async () => {
      const arg = { id: 11965 };
    ...
    it('dispatches PARTIAL_UPDATE_CASEDOCUMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CASEDOCUMENT actions', async () => {
      const arg = 42666;
